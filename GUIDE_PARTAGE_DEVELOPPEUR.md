# 🚀 Guide de Partage - Edusco pour Développeur Distant

## 📋 Résumé du Projet

**Edusco** est une plateforme de gestion académique complète développée avec Flask et MySQL. Elle permet la gestion des étudiants, enseignants, notes, absences, emplois du temps avec des interfaces adaptées selon les rôles utilisateurs.

## 🎯 Objectif de ce Guide

Ce guide vous permettra de configurer et utiliser le projet Edusco sur votre machine en moins de 30 minutes, même si vous êtes un développeur distant.
...
# Mettre à jour WSL si nécessaire
wsl --update
...
- **Accès** : Saisie de notes, gestion des absences

### Étudiant
- **Email** : etudiant@edusco.com
- **Mot de passe** : etudiant123
- **Accès** : Consultation des notes et absences
...
### Performance
- L'application est optimisée pour le développement
- Pour la production, configurez un serveur WSGI (Gunicorn)
...
**📧 Contact** : Pour toute question, n'hésitez pas à contacter l'équipe de développement. 